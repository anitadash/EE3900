...
\solution Below is the python code for the question.
\begin{lstlisting}
 wget https://github.com/anitadash/EE3900/blob/main/Pingala/Codes/Section_1.py
\end{lstlisting}
...
\solution Below is the python code that generates the stem plot of $x(n)$ in fig-\ref{fig:1}.
\begin{lstlisting}
 wget https://github.com/anitadash/EE3900/blob/main/Pingala/Codes/Section_2_2.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{/home/anitadash/Documents/Pingala_Images/ping_1.pdf}
\end{center}
\captionof{figure}{}
\label{fig:1}	
\end{figure}
...
\begin{align}
    ...
    &\mathcal{Z}^+\sbrak{x(n + 2)} = z^2X^+(z) - z^2.1 - z.1\\
    &\mathcal{Z}^+\sbrak{x(n + 1)} = zX^+(z) - z.1 \\
    & z^2X^+(z) - z^2.1 - z.1 = zX^+(z) - z.1 + zX^+(z) \\
...
\end{align}
\solution Below is the python code that generates the plot of $y(n)$ in fig-\ref{fig:2}.
\begin{lstlisting}
 wget https://github.com/anitadash/EE3900/blob/main/Pingala/Codes/Section_2_5.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{/home/anitadash/Documents/Pingala_Images/ping_2.pdf}
\end{center}
\captionof{figure}{}
\label{fig:2}	
\end{figure}
...
\end{align}
$\alpha, \beta$ are the roots of the equation $z^{2}-z-1$
\begin{equation}
...
= \alpha^{n + 1} + \beta^{n + 1}
\end{equation}
Thus, $y(n) = \alpha^{n + 1} + \beta^{n + 1}$ for $n \geq 0$ as $\alpha + \beta = 1$.with the definition of $b_n$, we see that $y(n) = b_{n + 1}$.
...
\end{align}
		and find $W(z)$.\\
\solution Putting $n = k + 1$ and using the definition of $u(n)$, 
\begin{align}
...
\end{align}
We have solved the remaining options in the problems earlier. Therefore, options 1, 2,and 3 are correct and option 4 is incorrect.
\end{enumerate}
\end{document}